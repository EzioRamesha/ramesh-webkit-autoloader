...
/* Title ID of the installed homescreen app ("Iris" — Games row) */
#define WKAL_TITLE_ID "IRIS00001"

/* Legacy Media-row title from stock PLK / early lab installs — removed on update */
#define WKAL_LEGACY_TITLE_ID "WKAL00001"
